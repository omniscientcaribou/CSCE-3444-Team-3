...
// This is a Modal (or Overlay or Popup) which displays when we click the call waitstaff button
// Props include:
...
const CallWSPopup = ({ showPopup, setShowPopup, text, heading, btn_text }) => {
